...
export default function Home() {
  const products = [{commodity_code: "03079100",
  commodity_code_description: "Live, fresh or chilled molluscs, even in shell (excl. oysters, scallops of the genera Pecten, Chlamys or Placopecten, mussels \"Mytilus spp., Perna spp.\", cuttle fish and squid, octopus \"Octopus spp.\", snails other than sea snails, clams, cockles and ark shells, abalone and stromboid conchs); fresh or chilled flours, meals and pellets of molluscs, fit for human consumption",
